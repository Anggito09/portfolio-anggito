(()=>{
  ...
  style.textContent=`
    ...
    #projects .beligo-links{display:flex;gap:10px;flex-wrap:wrap;margin:14px 0 2px}
    #projects .beligo-links a{display:inline-flex;align-items:center;gap:6px;padding:9px 16px;border-radius:999px;font-size:.78rem;font-weight:800;text-decoration:none;transition:transform .22s ease,box-shadow .22s ease,filter .22s ease}
    #projects .beligo-links a:hover{transform:translateY(-2px);filter:brightness(1.08)}
    #projects .beligo-link-live{background:linear-gradient(135deg,#34d399,#fcd34d);color:#062b16;box-shadow:0 10px 26px rgba(52,211,153,.28)}
    #projects .beligo-link-github{border:1px solid rgba(148,163,184,.3);background:rgba(255,255,255,.04);color:#e2e8f0}
