(()=>{
  ...
  style.textContent=`
    ...
    @media(max-width:600px){#projects .cityconnect-featured{padding:20px 15px;border-radius:19px}#projects .cityconnect-featured>h3{font-size:1.65rem}#projects .cityconnect-featured>p{font-size:.84rem}#projects .cityconnect-preview{margin-top:4px;padding:16px 12px 14px;border-radius:18px}#projects .cityconnect-preview-title{gap:6px 9px}#projects .cityconnect-preview-title strong{font-size:.93rem}#projects .cityconnect-preview-head small{font-size:.67rem;line-height:1.55}#projects .cityconnect-preview-grid{grid-template-columns:repeat(2,minmax(0,1fr));grid-auto-columns:unset;grid-auto-flow:unset;gap:12px;overflow:visible;padding:4px 2px 2px;scroll-snap-type:none}#projects .cityconnect-screen{padding:8px 6px 10px;border-radius:18px}#projects .cityconnect-device{min-height:auto}#projects .cityconnect-screen img{height:320px;max-height:62vw;border-radius:14px}#projects .cityconnect-screen figcaption{min-height:46px;font-size:.7rem}#projects .cityconnect-screen figcaption span{font-size:.48rem}.cityconnect-lightbox{padding:16px}.cityconnect-lightbox button{right:14px;top:14px}}
