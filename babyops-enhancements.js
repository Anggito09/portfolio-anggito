(()=>{
  ...
  style.textContent=`
    ...
    #projects .babyops-cry-grid span{display:flex;flex-direction:column;align-items:center;justify-content:center;min-height:66px;padding:9px 7px;border-radius:14px;border:1px solid rgba(103,232,249,.12);background:linear-gradient(145deg,rgba(103,232,249,.035),rgba(139,92,246,.035));transition:transform .25s ease,border-color .25s ease,box-shadow .25s ease}
    ...
    #projects .babyops-cry-grid b{font-size:.82rem;color:#8be9f5;letter-spacing:.02em}#projects .babyops-cry-grid small{margin-top:4px;font-size:.61rem;color:#8fa2bd;text-align:center}
    ...
    @media(prefers-reduced-motion:reduce){#projects .babyops-enhanced::after,#projects .babyops-enhanced h3,#projects .babyops-enhanced .project-topline,#projects .babyops-enhanced>p,#projects .babyops-award,#projects .babyops-detail{animation:none!important;transition:none!important}}
  `;
